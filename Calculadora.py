...
def click_boton(valor):
    global i
    e_texto.insert(i,valor) # el primer parametro es la posicion
    i+=1
def borrar():
...
e_texto.grid(row=0,column=0,columnspan=4,padx=5,pady=5)# el padx es el espacio entre la ventana y el widget// el columspan son las columnas que habran debajo
